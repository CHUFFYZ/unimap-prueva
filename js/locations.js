const campuses = {
    ...
    'Jardin Botanico': { 
        w: 2049, 
        h: 1521, 
        svg: '../../../image/mapa/jardin.svg', 
        geojson: '../../../data/jardin_buildings.json', 
        center: [700, 1200], // [lat, lng]
        zoom: 0 // Zoom inicial
    },
    'Centro Cultural Universitario': { 
        w: 2049, 
        h: 1521, 
        svg: '../../../image/mapa/ccu.svg', 
        geojson: '../../../data/ccu_buildings.json', 
        center: [700, 1200], // [lat, lng]
        zoom: 0 // Zoom inicial
    },
    'Museo Guanal': { 
        w: 2049, 
        h: 1521, 
        svg: '../../../image/mapa/museo.svg', 
        geojson: '../../../data/museo_buildings.json', 
        center: [700, 1200], // [lat, lng]
        zoom: 0 // Zoom inicial
    },
    'Campus Sabancuy': { 
        w: 2049, 
        h: 1521, 
        svg: '../../../image/mapa/sabancuy.svg', 
        geojson: '../../../data/sabancuy_buildings.json', 
        center: [700, 1200], // [lat, lng]
        zoom: 0 // Zoom inicial
    }
};
