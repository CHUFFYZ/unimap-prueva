    ...
    <div class="main-wrapper">
        ...
        <div class="supercontainer">
            <div class="containerlogo">
                <a id="logoweb" class="fl" href="sesion-profe.php"><img src="../../image/iconos/logo/unimap.webp" alt="LogoUnimap"></a>
            </div>
        ...
        <div class="fondosupercontainer">
            ...
            <div class="containerini">
                <form method="POST" action="../back-end/log-usuario/log-profe.php">
                    <div class="logosweb">
                        <div class="intalumno" id="inicioalumno">
                            <h2>Docente</h2>
                        </div>
                        <div class="logoalum"> 
                            <a id="logalum"><img src="../../image/iconos/userini/profesor.png" alt="alumnoslogo"></a>
                        </div>     
                    </div>
