    ...
    <div class="main-wrapper">
        ...
        <div class="supercontainer">
            <div class="containerlogo">
                <a id="logoweb" class="fl" href="sesion-admin.php"><img src="../../image/iconos/logo/unimap.webp" alt="LogoUnimap"></a>
            </div>
        ...
        <div class="fondosupercontainer">
            ...
            <div class="containerini">
                <form method="POST" action="../back-end/log-usuario/log-admin.php">
                    <div class="logosweb">
                        <div class="intalumno" id="inicioalumno">
                            <h2>Administrativo</h2>
                        </div>
                        <div class="logoalum"> 
                            <a id="logalum"><img src="../../image/iconos/userini/admin.webp" alt="alumnoslogo"></a>
                        </div>     
                    </div>
