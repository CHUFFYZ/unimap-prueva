...
<head>
    ...
    <title>Gestión de Administrativos - UNIMAP</title>
...
<body>
    <header class="welcome-header">
        <div>
            ...
            <p>Sistema de Gestión de Administrativos - UNIMAP</p>
        </div>
        <div class="log">
            <a id="logoweb" class="fl" href="mod-elim-admin.php"><img src="../../../image/iconos/logo/unimap.webp" alt="Logo Universidad"></a>
        </div>
    </header>

    <div class="container">
        <div class="section">
            <a href="alta-admin.php" class="btn-secondary"><i class="fas fa-arrow-left"></i> Regresar</a>
        </div>
        ...
        <div class="section">
            <h2>Baja de Administrativos</h2>
            <!-- Baja Individual -->
            <form id="deleteForm" method="POST" action="../../back-end/admin-gest/eliminar/eliminar-admin.php" class="excel-form">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="../../back-end/admin-gest/eliminar/confirmar-eliminar-admin.php">
            ...
            <div class="bulk-delete-section" id="bulkDeleteSection">
                <div class="table-container">
                    <h3>Administrativos Seleccionados para Eliminar</h3>
                    ...
                    <h3>Todos los Administrativos</h3>
                    <table id="allAdminsDelete">
                        <thead>
                            <tr>
                                <th>Matrícula</th>
                                <th>Nombre</th>
                        ...
                        <tbody>
                            ...
                            $stmt = $pdo->query("SELECT matricula, nombre, apellido, telefono, email FROM administrativos");
    ...
    <script>
        ...
        document.getElementById('selectedDelete').addEventListener('click', function(e) {
            ...
            const allAdminsTable = document.getElementById('allAdminsDelete').querySelector('tbody');
        ...
        function confirmBulkDelete() {
            if (selectedForDelete.length === 0) {
                alert('No hay administrativos seleccionados para eliminar');
                return;
            }
            if (confirm('¿Está seguro de eliminar los administrativos seleccionados?')) {
                const form = document.createElement('form');
                form.method = 'POST';
                form.action = '../../back-end/admin-gest/eliminar/eliminar-admin-masivo.php';
        ...
        function saveModifications(row) {
            ...
            const form = document.createElement('form');
            form.method = 'POST';
            form.action = '../../back-end/admin-gest/modificar/modificar-admin.php';
            const input = document.createElement('input');
            input.type = 'hidden';
            input.name = 'admin';
