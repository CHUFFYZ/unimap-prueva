...
<body>
    ...
    <div class="container">
        ...
        <div class="steps-container" id="steps-container">
            <div class="step">
                <h3>Paso 1: Inicia sesión como Administrativo</h3>
                <p>Después de iniciar sesión, UniMap se cargará en el modo "Administrativo". Para una buena experiencia, confirma que tu conexión a internet sea estable.</p>
