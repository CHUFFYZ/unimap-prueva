...
<body>
    <header class="welcome-header">
        <div>
            ...
            <h4>Altas</h4>
            <p>Registro de Administrativos - UNIMAP</p>
        </div>
        <div class="log">
            <a id="logoweb" class="fl" href="alta-admin.php"><img src="../../../image/iconos/logo/unimap.webp" alt="Logo Universidad"></a>
        </div>
    </header>
    ...
    <div class="container">
        <div class="section">
            ...
            <a href="mod-elim-admin.php" class="btn-primary"><i class="fas fa-user-plus"></i> Modificar-Eliminar Administrativos</a>
        </div>

        <div class="section">
            <h2>Alta de Administrativos</h2>
            ...
            <!-- Alta Individual -->
            <form id="adminForm" method="POST" action="../../back-end/admin-gest/registrar/registrar-admin.php" class="excel-form">
            ...
            <!-- Alta Masiva -->
            <div class="excel">
                <form method="POST" action="../../back-end/admin-gest/registrar/registrar-admin-masivo.php" enctype="multipart/form-data" class="excel-form">
                ...
                <div class="downloadcontainer">
                    <div class="downloadexel">
                        <a href="../../archivos/Estructura-Administrativos.xlsx" download class="btn-secondary">Descargar Estructura</a>
                    </div>
                </div>
            </div>
        </div>
