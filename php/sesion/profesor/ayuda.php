...
<body>
    ...
    <div class="container">
        <h1>Ayuda con UNIMAP Docentes</h1>
        ...
        <div class="steps-container" id="steps-container">
            <div class="step">
                <h3>Paso 1: Inicia sesión como Docente</h3>
                <p>Después de iniciar sesión, UniMap se cargará en el modo "Docente". Para una buena experiencia, confirma que tu conexión a internet sea estable.</p>
